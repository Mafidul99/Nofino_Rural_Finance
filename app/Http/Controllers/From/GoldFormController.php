...
class GoldFormController extends Controller
{
    public function show(){
        return view('froms.loan.gold-from');
    }
    ...
    public function composeEmail(Request $request) {
        ...
        $request->validate([
            ...
            //'pancardimage' => 'required|mimes:pdf,doc,docx|max:2048',
            //'aadhcardimage' => 'required|mimes:pdf,doc,docx|max:2048',
            //'purchinvoice' => 'required|mimes:pdf,doc,docx|max:2048',
            //'bankpassimage' => 'required|mimes:pdf,doc,docx|max:2048',
            //'yphotoimage' => 'required|mimes:png,jpeg,jpg|max:2048',
                        ...
                        <table style=' width: 302px; margin: 0 auto; width: 602px;' width='602' border='0' cellspacing='0' cellpadding='0'>
                            <tbody>
                                <tr>
                                    ...
                                    <td styel='width: 300px; padding: 8px 0; color: #616161 !important; font-weight: 400; font-size: 12px; line-height: 14px;' width='300'>
        ...
        try {
            ...
            if(isset($_FILES['hallmarkcerti'])) {
                for ($i=0; $i < count($_FILES['hallmarkcerti']['tmp_name']); $i++) {
                    $mail->addAttachment($_FILES['hallmarkcerti']['tmp_name'][$i], $_FILES['hallmarkcerti']['name'][$i]);
                }
            }
            ...
            $mail->Subject = 'Gold Loan Request';
            $mail->Body    = $html;
