...
class ProductFormController extends Controller
{
    public function show(){
        return view('froms.loan.product-form');
    }
    ...
    public function composeEmail(Request $request) {
        ...
        try {
            ...
            if(isset($_FILES['purchinvoice'])) {
                for ($i=0; $i < count($_FILES['purchinvoice']['tmp_name']); $i++) {
                    $mail->addAttachment($_FILES['purchinvoice']['tmp_name'][$i], $_FILES['purchinvoice']['name'][$i]);
                }
            }
