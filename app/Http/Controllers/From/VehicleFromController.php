...
class VehicleFromController extends Controller
{
    public function show(){
        return view('froms.loan.vehilce-from');
    }
    ...
    public function composeEmail(Request $request) {
        ...
        $request->validate([
            ...
            'vehiclercno' => 'required|min:3|max:100',
            'insuranceno' => 'required|min:3|max:100',
            'puccno' => 'required|min:3|max:100',
            //'signatimage' => 'required|mimes:png,jpeg,jpg|max:2048',
                                                ...
                                                <tr>
                                                    <td style='padding: 0 24px;'>
                                                        ...
                                                        <hr>
                                                            ...
                                                            <p style='margin-top: 0;margin-bottom: 16px;color: #212121;font-family: Roboto, Helvetica, sans-serif;
                                                            font-weight: 400; font-size: 16px;line-height: 24px;'>
                                                                Marital Status: $vehiclercno
                                                            </p>
                                                            <p style='margin-top: 0;margin-bottom: 16px;color: #212121;font-family: Roboto, Helvetica, sans-serif;
                                                            font-weight: 400; font-size: 16px;line-height: 24px;'>
                                                                Marital Status: $insuranceno
                                                            </p>
                                                            <p style='margin-top: 0;margin-bottom: 16px;color: #212121;font-family: Roboto, Helvetica, sans-serif;
                                                            font-weight: 400; font-size: 16px;line-height: 24px;'>
                                                                Marital Status: $puccno
                                                            </p>
                                                            <p style='margin-top: 0;margin-bottom: 16px;color: #212121;font-family: Roboto, Helvetica, sans-serif;
                                                            font-weight: 400; font-size: 16px;line-height: 24px;'>
                                                        ...
                                                        <p style=' color: #616161;font-size: 12px;line-height: 20px;'>Thanks,<br>
        ...
        try {
            ...
            if(isset($_FILES['vehiclerc'])) {
                for ($i=0; $i < count($_FILES['vehiclerc']['tmp_name']); $i++) {
                    $mail->addAttachment($_FILES['vehiclerc']['tmp_name'][$i], $_FILES['vehiclerc']['name'][$i]);
                }
            }
            if(isset($_FILES['insurancecopy'])) {
                for ($i=0; $i < count($_FILES['insurancecopy']['tmp_name']); $i++) {
                    $mail->addAttachment($_FILES['insurancecopy']['tmp_name'][$i], $_FILES['insurancecopy']['name'][$i]);
                }
            }
            if(isset($_FILES['pucccopy'])) {
                for ($i=0; $i < count($_FILES['pucccopy']['tmp_name']); $i++) {
                    $mail->addAttachment($_FILES['pucccopy']['tmp_name'][$i], $_FILES['pucccopy']['name'][$i]);
                }
            }
            ...
            $mail->Subject = 'Product Loan Request';
            $mail->Body    = $html;
