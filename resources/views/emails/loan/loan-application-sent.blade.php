            ...
            <tbody>
                <tr>
                    ...
                    <td class="subject" width="300">
                        <a class="strong" href="https://nofinofinance.com" target="_blank">
                    ...
                    <td class="column">
                        ...
                        <table class="content" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td class="padded">
                                        <h1 class="text-align:center">Hello, You have get an Enquiiry!...</h1>
                                        <p>Your Name: {{ $request['name'] }}</p>
                                        <p>Father Name: {{ $request['fname'] }}</p>
                                        <p>Mother Name: {{ $request['mname'] }}</p>
                                        <p>Your Email: {{ $request['email'] }}</p>
                                        <p>Date of Birth: {{ $request['birthdate'] }}</p>

                                        <p style="text-align:center;">
                                            <a href="https://nofinofinance.com" target="_blank" class="btn">
                                                Nofino Rural Finance
                                            </a>
                                        </p>
                                        <p class="caption">Thanks,<br>
            ...
            <tbody>
                ...
                <tr>
                    <td class="signature" width="300">
                        ...
                        <p>
                            Support: <a class="strong" href="mailto:support@nofinofinance.com"
