    ...
    <div class="container">
        <div class="row">
            <div class="breadcumb-content">
                <h1>Group Loan Details</h1>
                <div class="breadcumb-inner">
                    <ul>
                        <li><a href="{{url('/')}}">Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><a href="{{url('/group')}}">Group Loan Details</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="feature-about-us mb-30">
                    ...
                    <div class="btn-common btn-download">
                        <a href="{{ url('/group-form') }}">Apply Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-8">
                <div class="service-details-content">
                    <div class="content-title">
                        <h3>Group Loan Overview</h3>
                    </div>
                    <div class="content-txt">
                        <p>A group loan from Nofino Rural Finance Private Limited enables members of a community to access low-interest financing collectively, fostering mutual support and shared responsibility. This collaborative approach empowers individuals to achieve their goals, strengthens community bonds, and promotes sustainable economic growth in North East India.</p>
                    </div>
                    <div class="content-thumb">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <img src="{{url('assets/images/loan/g_loans.svg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                    <div class="content-title">
