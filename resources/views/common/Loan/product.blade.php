    ...
    <div class="container">
        <div class="row">
            <div class="breadcumb-content">
                <h1>Product Loan Details</h1>
                <div class="breadcumb-inner">
                    <ul>
                        <li><a href="{{url('/')}}">Home</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li><a href="{{url('/product')}}">Product Loan Details</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="feature-about-us mb-30">
                    ...
                    <div class="btn-common btn-download">
                        <a href="{{ url('/product-form') }}">Apply Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-8">
                <div class="service-details-content">
                    <div class="content-title">
                        <h3>Product Loan Overview</h3>
                    </div>
                    <div class="content-txt">
                        <p>At Nofino Rural Finance Private Limited, our product loans offer low-interest rates to support your goals. Whether expanding your business, investing in agriculture, or enhancing your home, our tailored financial solutions make achieving your dreams affordable and accessible. Partner with us for your journey to success.</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-unstyled about-two__list service-details__list">
                                    ...
                                    <li>
                                        <i class="fa fa-check-circle"></i> Product Purchase Invoice.
                                    </li>
                                    <li>
