        ...
        <div class="container">
            <div class="row">
                <div class="breadcumb-content">
                    <h1>Gold Application From</h1>
                    <div class="breadcumb-inner">
                        <ul>
                            <li><a href="{{ url('/') }}">Home</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="{{ url('/gold-from') }}">Gold Loan Application From</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-area upper">
                                ...
                                @endif
                                <form action="{{ route('gold.from.sent') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row pb-3">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Hallmark Certificate<span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" id="hallmarkcerti" name="hallmarkcerti[]" multiple="multiple" class="form-control" required />
