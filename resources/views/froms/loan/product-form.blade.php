        ...
        <div class="container">
            <div class="row">
                <div class="breadcumb-content">
                    <h1>Product Application From</h1>
                    <div class="breadcumb-inner">
                        <ul>
                            <li><a href="{{ url('/') }}">Home</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="{{ url('/products-from') }}">Product Loan Application From</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head style-2 pb-30">
                        <h5>Loan Form</h5>
                        <h2>PRODUCT LOAN APPLICATION FORM</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-area upper">
                                ...
                                @endif
                                <form action="{{ route('product.from.sent') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row pb-3">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Purchase Invoice <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" id="purchinvoice" name="purchinvoice[]" multiple="multiple" class="form-control" required />
