        ...
        <div class="container">
            <div class="row">
                <div class="breadcumb-content">
                    <h1>Group Application From</h1>
                    <div class="breadcumb-inner">
                        <ul>
                            <li><a href="{{ url('/') }}">Home</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="{{ url('/group-from') }}">Group Loan Application From</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head style-2 pb-30">
                        <h5>Loan Form</h5>
                        <h2>GROUP LOAN APPLICATION FORM</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-area upper">
                                ...
                                @endif
                                <form action="{{ route('group.from.sent') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row pb-3">
                                        <div class="col-md-12">
