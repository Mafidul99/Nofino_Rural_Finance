        ...
        <div class="container">
            <div class="row">
                <div class="breadcumb-content">
                    <h1>Vehicle Application From</h1>
                    <div class="breadcumb-inner">
                        <ul>
                            <li><a href="{{ url('/') }}">Home</a></li>
                            <li><i class="fa fa-angle-right"></i></li>
                            <li><a href="{{ url('/vehilce-from') }}">Vehicle Loan Application From</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-area upper">
                                ...
                                @endif
                                <form action="{{ route('vehilce.from.sent') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row pb-3">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="loan___label">Vehicle Rc Number <span style="color:red;">*</span></label>
                                                <input type="text" name="vehiclercno" placeholder="Vehicle Rc Number " class="form-control" />
                                                @error('vehiclercno')
                                                    <span style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="loan___label">Insurance Number <span style="color:red;">*</span></label>
                                                <input type="text" name="insuranceno" placeholder="Insurance Number " class="form-control" />
                                                @error('insuranceno')
                                                    <span style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="loan___label">PUCC Number<span style="color:red;">*</span></label>
                                                <input type="text" name="puccno" placeholder="PUCC Number " class="form-control" />
                                                @error('puccno')
                                                    <span style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Pan Card <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" name="pancardimage[]" id="pancardimage" multiple="multiple" class="form-control" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Aadhaar Card <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" name="aadhcardimage[]" id="aadhcardimage" multiple="multiple" class="form-control" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Vehicle Rc<span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" id="vehiclerc" name="vehiclerc[]" multiple="multiple" class="form-control" required />
                                        ...
                                        <div class="col-md-4 pt-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Insurance Copy <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" name="insurancecopy[]" id="insurancecopy" multiple="multiple"  class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pt-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>PUCC Copy <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" name="pucccopy[]" id="pucccopy" multiple="multiple"  class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 pt-4">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label>Bank Passbook <span style="color:red;">* (PDF)</span></label>
                                                    </div>
                                                    <input type="file" name="bankpassimage[]" id="bankpassimage" multiple="multiple"  class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
